...
class Colour:
	...
	def __init__(self, name: str = 'white', r: int = 255, g: int = 255, b: int = 255): ...
	@cached_property
	def as_hex(self) -> str: ...
...
class _ColourSelectorMixin:
	...
	def __init__(self, button_id: int = 0, default_colour: Colour = Colour('white', 255, 255, 255), widget_theme: ThemeParameters = None): ...
...
class _ColourScale(QWidget):
	def __init__(self, colours: list[Colour] = None, steps: int = 0, horizontal: bool = False): ...
	@classmethod
...
class _ColourScaleCreatorMixin:
	...
	def __init__(self, colours: list[Colour] = None, horizontal: bool = False, widget_theme: ThemeParameters = None, parent: QMainWindow = None): ...
	def _setup_connections(self) -> None: ...
	def _setup_ui(self) -> None: ...
...
class ColourScaleCreator(_ColourScaleCreatorMixin, QDialog):
	def __init__(self, colours: list[Colour] = None, horizontal: bool = False, widget_theme: ThemeParameters = None): ...
	def _setup_connections(self) -> None: ...
	def _setup_ui(self) -> None: ...
	def _slot_add_colour(self) -> None: ...
	def _slot_apply(self) -> None: ...
...
class ColourScaleCreatorDW(_ColourScaleCreatorMixin, QDockWidget):
	def __init__(self, parent: QMainWindow, colours: list[Colour] = None, horizontal: bool = False, widget_theme: ThemeParameters = None): ...
	def _setup_connections(self) -> None: ...
	def _setup_ui(self) -> None: ...
	def _slot_add_colour(self) -> None: ...
	def _slot_apply(self) -> None: ...
